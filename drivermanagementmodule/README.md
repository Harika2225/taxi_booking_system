# drivermanagementmodule prototype
...
On launch, drivermanagementmodule will refuse to start if it is not able to connect to any of the above component(s).
...
Build the docker image: `docker build -t drivermanagementmodule:latest .`

Start the container: `docker run -d -p 9021:9021 drivermanagementmodule:latest`
