# bookingmanagementmodule prototype
...
On launch, bookingmanagementmodule will refuse to start if it is not able to connect to any of the above component(s).
...
Open [http://localhost:9022/hello](http://localhost:9022/hello) to view it in your browser.

The page will reload when you make changes.

## Containerization

Build the docker image: `docker build -t bookingmanagementmodule:latest .`

Start the container: `docker run -d -p 9022:9022 bookingmanagementmodule:latest`
